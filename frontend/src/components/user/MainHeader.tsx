...
import { FiSearch, FiShoppingCart, FiUser, FiBox, FiLogOut, FiKey, FiHeart, FiChevronDown } from "react-icons/fi";
       ...
       <div className="flex space-x-8 mx-4">
        ...
        <div className="flex items-center space-x-6">
            ...
            <input 
              type="text" 
              placeholder="Search..." 
              className="w-72 px-4 py-2.5 rounded-full border border-gray-200 text-black focus:outline-none focus:ring-2 focus:ring-teal-500 transition-all shadow-sm" 
