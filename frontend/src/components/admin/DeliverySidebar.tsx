      ...
      >
        ...
        <div className="pt-8 pb-6 px-6">
          <div className="flex items-center">
            ...
            <div className="ml-3">
              <h2 className="text-xl font-bold text-white">Delivery Portal</h2>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col h-[calc(100%-140px)] overflow-y-auto custom-scrollbar">
          ...
          <div className="px-4 mb-6">
            ...
            <ul className="space-y-1">
              <li>
                <Link
                  ...
                  className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-all duration-150 ${
                    isActive("/deliveryboy/dashboard")
              ...
              <li>
                <Link
                  to="/deliveryboy/pending-status"
                  className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-all duration-150 ${
                    isActive("/deliveryboy/pending-status")
                      ? "bg-gradient-to-tr from-teal-600/80 to-emerald-500/80 text-white shadow-md shadow-teal-900/20"
                      : "text-slate-300 hover:bg-white/10"
                  }`}
                >
              ...
              <li>
                <Link
                  to="/deliveryboy/processing"
                  className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-all duration-150 ${
                    isActive("/deliveryboy/processing")
                      ? "bg-gradient-to-tr from-teal-600/80 to-emerald-500/80 text-white shadow-md shadow-teal-900/20"
                      : "text-slate-300 hover:bg-white/10"
                  }`}
                >
              ...
              <li>
                <Link
                  to="/deliveryboy/shipped"
                  className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-all duration-150 ${
                    isActive("/deliveryboy/shipped")
                      ? "bg-gradient-to-tr from-teal-600/80 to-emerald-500/80 text-white shadow-md shadow-teal-900/20"
                      : "text-slate-300 hover:bg-white/10"
                  }`}
                >
              ...
              <li>
                <Link
                  to="/deliveryboy/deliverd"
                  className={`flex items-center space-x-3 px-3 py-2.5 rounded-lg transition-all duration-150 ${
                    isActive("/deliveryboy/deliverd")
                      ? "bg-gradient-to-tr from-teal-600/80 to-emerald-500/80 text-white shadow-md shadow-teal-900/20"
                      : "text-slate-300 hover:bg-white/10"
                  }`}
                >
