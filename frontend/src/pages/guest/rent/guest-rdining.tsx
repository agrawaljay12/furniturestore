...
const guestdining: React.FC = () => {
  ...
  const [sortBy, setSortBy] = useState("price"); // Change from "title" to "price"
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      const bodyContent = JSON.stringify({
        ...
        search: searchQuery,
        title: "Dining", // Use category field correctly
        is_for_rent: true
      });
  ...
  return (
    <React.Fragment>
      ...
      <div className="min-h-screen bg-gray-50 px-8 pt-24 pb-16">
              ...
              <div className="absolute right-0 mt-2 w-60 bg-white border border-gray-200 rounded-lg shadow-xl z-10 animate-fadeIn">
                <div className="py-2">
                  ...
                  {[
                    ...
                    { id: "created_at", label: "Date Added", icon: "M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121 7.5v11.25m-18 0A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75m-18 0A2.25 2.25 0 015.25 9h13.5A2.25 2.25 0 0121 11.25v7.5" }
                  ].map((option) => (
        ...
        {/* ...existing preview product modal... */}
