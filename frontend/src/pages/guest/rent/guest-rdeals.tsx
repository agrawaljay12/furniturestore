...
const GuestDeals: React.FC = () => {
  ...
  const handleAddToCart = () => {
    // For guest users, we show login popup when they try to add to cart
  ...
  const handleAddToWishlist = () => {
    // For guest users, we show login popup when they try to add to wishlist
    setShowLoginPopup(true);
  };

  // const isProductInWishlist = (productId: string) => {
  //   return false; // Guest users don't have a wishlist until they log in
  // };
          ...
          <div className="bg-red-50 border border-red-200 text-red-800 rounded-lg p-4 mb-8 flex items-start">
            <div className="flex-shrink-0 mt-0.5">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-red-500" viewBox="0 0 20 20" fill="currentColor">
                <path fillRule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0116 0zm-7 4a1 1 0 11-2 0 1 1 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 00-2 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
              </svg>
            </div>
            <div className="ml-3">
            ...
            {showSortOptions && (
              <div className="absolute right-0 mt-2 w-60 bg-white border border-gray-200 rounded-lg shadow-xl z-10 animate-fadeIn">
                <div className="py-2">
                  ...
                  {[
                    { id: "price", label: "Price", icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 01-18 0 9 9 0118 0z" },
            ...
            {displayedProducts.map((product, index) => (
              ...
              >
                <div className="relative">
                  ...
                  <button
                    className="absolute bottom-3 right-3 text-xl transition-all p-2 bg-white rounded-full shadow-lg text-gray-400 hover:text-red-500 hover:scale-110"
                    aria-label="Wishlist"
                    onClick={(e) => {
                      e.stopPropagation();
                      handleAddToWishlist();
            ...
            >
              ...
              <div className="flex space-x-3">
                <button
                  ...
                  className="flex-1 py-3 rounded-lg transition-all flex items-center justify-center space-x-2 bg-teal-600 hover:bg-teal-500 text-white"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                    <path d="M3 1a1 1 0 0 0 0 2h1.22l.305 1.222a.997.997 0 0 0 .01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 0 0 0-2H6.414l1-1H14a1 1 0 0 0 .894-.553l3-6A1 1 0 0 0 17 3H6.28l-.31-1.243A1 1 0 0 0 5 1H3z" />
                  </svg>
                ...
                <button
                  ...
                  className="p-3 rounded-lg border border-gray-300 hover:bg-gray-50 text-gray-700"
                >
                  <FiHeart className="w-5 h-5" />
                </button>
              </div>
            ...
            <div className="bg-white rounded-xl p-6 max-w-md w-full shadow-2xl transform transition-all duration-300 scale-100">
              ...
              <div className="mb-6">
                ...
                <p className="text-xs text-gray-500 text-center">
                  Create an account to enjoy a personalized shopping
                  experience!
                </p>
              </div>
