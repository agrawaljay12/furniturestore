...
const guestdining: React.FC = () => {
  ...
  const [sortBy, setSortBy] = useState("price"); // Define sortBy variable
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      const bodyContent = JSON.stringify({
        ...
        search: searchQuery,
        title: "Dining", // Filter by bedroom category
      ...
      try {
        ...
        if (data && data.data) {
          ...
          const filteredProducts = data.data.filter(
            (product: Product) => product.is_for_sale === true
          );
  ...
  //   setShowLoginPopup(true); // Show login popup instead of preview
  // };
      ...
      <div className="fixed top-0 left-0 right-0 z-50">
        <Header
          ...
          onSearch={(query: string) => {
            ...
            // Make API call with search query and filter by is_for_sale
                  ...
                  {[
                    {
                      id: "price",
                      label: "Price",
                      icon: "M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0118 0z",
                    },
                    {
                      id: "title",
                      label: "Name",
                    ...
                    <div key={option.id} className="px-1">
                      <button
                        className={`w-full text-left px-4 py-3 flex justify-between items-center hover:bg-gray-50 rounded-md ${
                          sortBy === option.id
