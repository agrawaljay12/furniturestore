...
interface Product {
  ...
  discount?: string; // Required by CartContext
}

const MattressPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      const bodyContent = JSON.stringify({
        ...
        search: searchQuery,
        title: "Mattress", // Filter by mattress category
  ...
  const handleAddToCart = (product: Product, quantity: number) => {
    ...
    const productWithRequiredProps = {
      ...product,
      discountedPrice: product.discountedPrice || product.price, // Use price if discountedPrice is undefined
      discount: product.discount ? parseFloat(product.discount) : 0  // Convert to number
    };
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 px-8 pt-24 pb-16">
        <h2 className="text-3xl font-semibold text-center mb-8">Mattress Furniture</h2>

        {/* Sort and Filter Section */}
        <div className="flex justify-between items-center mt-12 px-6">
          <div>
            <h2 className="text-4xl font-sans text-gray-800 section-title">Mattress Collection</h2>
            <p className="text-lg text-gray-600 mt-2">Quality sleep solutions</p>
          </div>
