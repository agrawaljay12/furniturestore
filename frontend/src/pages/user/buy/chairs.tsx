...
interface Product {
  ...
  discountedPrice?: string; // Add missing property
...
const ChairsPage: React.FC = () => {
  ...
  const handleAddToCart = (product: Product, quantity: number) => {
    ...
    const productWithDefaults = {
      ...
      discount: product.discount || 0 // Set default value of 0 if discount is undefined
    };
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 px-8 pt-24 pb-16">
        ...
        <div className="flex justify-between items-center mt-6 mb-8 px-6">
          <div>
            <h2 className="text-2xl font-sans text-gray-800 section-title">Chair Collection</h2>
