...
interface Product {
  ...
  discountedPrice?: string; // Required by addToCart
  discount?: number; // Required by addToCart
}

const LivingPage: React.FC = () => {
  ...
  // Fetch products based on category (title) and other filters
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      const bodyContent = JSON.stringify({
        ...
        search: searchQuery,
        title: "Living Room", // Filter by living room category instead of title
  ...
  const handleAddToCart = (product: Product, quantity: number) => {
    ...
    // Ensure product has a discountedPrice before adding to cart
    const productWithDefaults = {
      ...product,
      discountedPrice: product.discountedPrice || product.price, // Use price as default if no discounted price
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 px-8 pt-24 pb-16">
        <h2 className="text-3xl font-semibold text-center mb-8">Living Room Furniture</h2>

        {/* Sort and Filter Section */}
        <div className="flex justify-between items-center mt-12 px-6">
          <div>
            <h2 className="text-4xl font-sans text-gray-800 section-title">Living Room Collection</h2>
            <p className="text-lg text-gray-600 mt-2">Create the perfect living space</p>
          </div>
            ...
            <div className="text-center mb-6">
              <div className="inline-block p-3 bg-blue-100 rounded-full mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-blue-600" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M18 10a8 8 011-16 0 8 8 0116 0zm-7-4a1 1 011-2 0 1 1 012 0zM9 9a1 1 000 2v3a1 1 001 1h1a1 1 100-2v-3a1 1 00-1-1H9z" clipRule="evenodd" />
                </svg>
              </div>
