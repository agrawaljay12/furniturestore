  ...
  useEffect(() => {
      const fetchProducts = async () => {
        ...
        const bodyContent = JSON.stringify({
          ...
          search: searchQuery,
          listing_type: "buy",
          title: "living room" // Filter for living room furniture,
        });
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 px-8 pt-24 pb-16">
        ...
        <div className="flex justify-between items-center mt-6 mb-8 px-6">
          <div>
            <h2 className="text-2xl font-sans text-gray-800 section-title">Living Room Collection</h2>
            <p className="text-sm text-gray-600 mt-1">find the perfect pieces for your living space</p>
          </div>
