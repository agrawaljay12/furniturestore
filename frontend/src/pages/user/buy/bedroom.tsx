  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      const bodyContent = JSON.stringify({
        ...
        search: searchQuery,
        title: "Bedroom", // Filter by bedroom category
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 px-8 pt-24 pb-16">
        ...
        <div className="flex justify-between items-center mt-6 mb-8 px-6">
          <div>
            <h2 className="text-2xl font-sans text-gray-800 section-title">Bedroom Collection</h2>
            <p className="text-sm text-gray-600 mt-1">Create your dream bedroom</p>
          </div>
              ...
              <div className="absolute right-0 mt-2 w-60 bg-white border border-gray-200 rounded-lg shadow-xl z-10 animate-fadeIn">
                <div className="py-2">
                  ...
                  {[
                    ...
                    { id: "created_at", label: "Date Added", icon: "M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 012.25-2.25h13.5A2.25 2.25 0121 7.5v11.25m-18 0A2.25 2.25 005.25 21h13.5A2.25 2.25 0021 18.75m-18 0v-7.5A2.25 2.25 005.25 9h13.5A2.25 2.25 0021 11.25v7.5" }
                  ].map((option) => (
