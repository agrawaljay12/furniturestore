...
interface Product {
  ...
  discountedPrice?: string; // Changed from number to string to match CartContext
  discount?: number; // Add missing property required by CartContext
}
...
const TablePage: React.FC = () => {
  ...
  const handleAddToCart = (product: Product, quantity: number) => {
    ...
    // Ensure product has a discountedPrice and discount before adding to cart
    const productWithDiscountedPrice = {
      ...product,
      discountedPrice: product.discountedPrice || product.price, // Use regular price if discounted not available
      discount: product.discount || 0 // Provide a default discount of 0 if not available
    };
    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 px-8 pt-24 pb-16">
        ...
        <div className="flex justify-between items-center mt-6 mb-8 px-6">
          <div>
            <h2 className="text-2xl font-sans text-gray-800 section-title">Available Tables</h2>
            <p className="text-sm text-gray-600 mt-1">Find the perfect table for your space</p>
          </div>
                ...
                <div className="mt-4 space-y-3">
                  ...
                  >
                   <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                      <path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 000 .042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 000-2H6.414l1-1H14a1 1 00.894-.553l3-6A1 1 0017 3H6.28l-.31-1.243A1 1 005 1H3z" />
                    </svg>
