    ...
    <>
      ...
      <div className="min-h-screen bg-gray-50 p-8 pt-24">
        ...
        <div className="max-w-3xl mx-auto text-gray-700">
          ...
          <p className="mb-4">
            At Furniture Store, we are committed to protecting your privacy and ensuring the security of your personal information. This privacy policy outlines our practices regarding the collection, use, and disclosure of your information when you visit our website or use our services.
          </p>
          ...
          <p>
            <strong>Email:</strong> info@furniturestore.com<br />
            <strong>Phone:</strong> +1 (555) 123-4567<br />
            <strong>Address:</strong> 123 Furniture Avenue, Design District, New York, NY 10001
          </p>
        </div>
      </div>
      {/* ChatWidget */}
