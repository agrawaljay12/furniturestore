...
interface Product {
  ...
  discount?: number; // Add missing property
}
...
const TablePage: React.FC = () => {
  ...
  const [sortBy, setSortBy] = useState("title"); // Changed default sort
  const [sortOrder, setSortOrder] = useState("asc"); // Added sort order
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      ...
      const bodyContent = JSON.stringify({
        ...
        page_size: 100,
        sort_by: sortBy,
        sort_order: sortOrder, // Added sort order to API request
        search: searchQuery,
        title: "Table" // Filter by table category
      });
    ...
    fetchProducts();
  }, [searchQuery, sortBy, sortOrder, page]); // Added sortOrder dependency
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 px-8 pt-24 pb-16">
        <h2 className="text-3xl font-semibold text-center mb-8">Table Furniture</h2>

        {/* Sort and Filter Section */}
        <div className="flex justify-between items-center mt-12 px-6">
          <div>
            <h2 className="text-4xl font-sans text-gray-800 section-title">Furniture Tables</h2>
                      ...
                      >
                        ...
                        {sortBy === option.id && (
                          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 text-yellow-600" viewBox="0 0 20 20" fill="currentColor">
                            <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 01-1.414 0z" clipRule="evenodd" />
                          </svg>
                        )}
                      </button>
                    </div>
        ...
        {isLoading ? (
          <div className="flex flex-col items-center justify-center py-12">
            ...
            <p className="text-gray-600 text-lg">Loading furniture...</p>
          </div>
        ) : displayedProducts.length === 0 ? (
          <div className="text-center py-12">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-16 w-16 mx-auto text-gray-400 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.172 16.172a4 4 0 015.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0118 0z" />
            </svg>
            <h3 className="text-xl font-semibold text-gray-700 mb-2">No furniture found</h3>
                  ...
                  <div className="mt-4">
                    ...
                    >
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path d="M3 1a1 1 000 2h1.22l.305 1.222a.997.997 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 000-2H6.414l1-1H14a1 1 00.894-.553l3-6A1 1 0017 3H6.28l-.31-1.243A1 1 005 1H3z" />
                      </svg>
                      Add to Cart
                    </button>
                  </div>
