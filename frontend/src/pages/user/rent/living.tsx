  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 px-8 pt-24 pb-16">
        <h2 className="text-3xl font-semibold text-center mb-8">Living Room Collection</h2>
            ...
            >
              ...
              <div className="mb-4">
                <div className="flex justify-between items-center mb-2">
                  <div className="text-2xl font-bold text-gray-900">${(parseFloat(previewProduct.rent_price) * quantity).toFixed(2)}/day</div>
