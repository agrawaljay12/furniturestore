  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-50 px-8 pt-24 pb-16">
        ...
        {/* Replace the existing sort controls with new dropdown */}
        <div className="flex justify-between items-center mt-12 px-6">
          <div>
            <h2 className="text-4xl font-sans text-gray-800 section-title">Storage Solutions</h2>
            <p className="text-lg text-gray-600 mt-2">Organize your space with style</p>
          </div>
        ...
        {/* Add the animation styles for the dropdown */}
        <style>{`
          @keyframes fadeIn {
          ...
          <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50">
            <div className="bg-white rounded-lg p-6 max-w-md w-full">
              <div className="flex justify-between items-center mb-4">
                ...
                <button onClick={closeLoginPopup} className="text-gray-500 hover:text-gray-700 text-xl font-bold">×</button>
              </div>
