...
function chairs(): React.ReactElement {
    ...
    const fetchFurniture = async () => {
      ...
      try {
        ...
        let bodyContent = JSON.stringify({
          ...
          sort_order: "asc",
          search: "",
          title: "chairs" // Fetch only chairs
        });
  ...
  // Updated image click handler to match ListFurniturePage
  ...
  // Function to handle deleting furniture
  ...
  // Remove the redundant handleImageChange function as it's replaced by handleFileChange
  ...
  // Add the renderImageSection function from ListFurniturePage
        ...
        <main className="flex-1 overflow-y-auto p-6 bg-slate-100">
          ...
          <div className="mb-6">
            <div className="flex items-center text-sm text-slate-500">
              ...
              <span className="mx-2">/</span>
              <span className="text-teal-600 font-medium">Chairs</span>
            </div>
          </div>
