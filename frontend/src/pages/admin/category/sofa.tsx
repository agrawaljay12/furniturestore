...
function sofa(): React.ReactElement {
    ...
    const fetchFurniture = async () => {
      ...
      try {
        ...
        let bodyContent = JSON.stringify({
          ...
          sort_order: "asc",
          search: "",
          title: "living room" // Fetch only tables
        });
        ...
        const fetchFurniture = async () => {
          ...
          try {
            ...
            let bodyContent = JSON.stringify({
              ...
              sort_order: "asc",
              search: "",
              title: "living room" // Fetch only living room items
            });
        ...
        <main className="flex-1 overflow-y-auto p-6 bg-slate-100">
          ...
          <div className="mb-6">
            <div className="flex items-center text-sm text-slate-500">
              ...
              <span className="mx-2">/</span>
              <span className="text-teal-600 font-medium">Living Room</span>
            </div>
          </div>
          ...
          <section className="py-8 px-4">
            <div className="bg-white rounded-xl shadow-md p-6 mb-8 border-t-4 border-teal-500">
              <h2 className="text-3xl font-bold text-slate-800 mb-6 flex items-center">
                ...
                Living Room Furniture Management
              </h2>
              {error && (
                ...
                <div className="w-full md:w-64">
                  <div className="relative">
                    <select
                      ...
                      className="block appearance-none w-full bg-white border border-slate-300 text-slate-700 py-3 px-4 pr-8 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-teal-500 transition-all duration-300"
                    >
